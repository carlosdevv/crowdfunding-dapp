...
import { useCampaignDetails } from "./use-campaign-details";
...
const CampaignDetails = ({ params }: { params: { id: number } }) => {
  const {
    ...
    handleDonate,
    setAmount,
  } = useCampaignDetails({ id: params.id });
    ...
    <div>
      ...
      <div className="w-full flex md:flex-row flex-col mt-10 gap-[30px]">
            ...
            <div
              ...
              style={{
                width: `${calculateBarPercentage(
                  campaignDetails?.target ?? 0,
                  campaignDetails?.amountCollected ?? 0
                )}%`,
                maxWidth: "100%",
              }}
            ></div>
        ...
        <div className="flex md:w-[150px] w-full flex-wrap justify-between gap-[30px]">
          ...
          <CountBox
            title={`Raised of ${campaignDetails?.target}`}
            value={campaignDetails?.amountCollected.toString() ?? ""}
          />
